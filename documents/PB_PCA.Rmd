...
```{r}
pbPCread <- read.table("C:/Users/ebola/ECL243//data/PCApbsubfulldata1.txt", comment.char = "", fill=T, sep="\t") #leaving header=true confused it, so I just read it in without, need to get rid of two rows
